...
class _SHBracket:
    ...
    def __init__(self, cs, n_configs, start_budget, max_budget, eta, rng):
        ...
        # Build the rung budget schedule by repeatedly multiplying start_budget
        # by eta until we exceed max_budget.
        # Example (NB301, eta=3, start_budget=1, max_budget=98):
        #   rungs = [1, 3, 9, 27, 81]
        # NOTE: standalone SH stops at the last power-of-eta multiple below r_max
        # (81 here) and never evaluates at r_max=98. This is by design per the
        # original paper. Hyperband compensates by anchoring its top bracket
        # directly at r_max, guaranteeing at least one bracket always hits r_max.
        self._rung_budgets = []
        b = start_budget
